...
<head>
    ...
    <meta name="description"
        content="Ocean Pearl Hotel - Trải nghiệm nghỉ dưỡng sang trọng với view biển tuyệt đẹp, dịch vụ 5 sao và các tiện ích hiện đại.">
...
<body class="">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center space-x-3 gentle-hover">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-ocean-400 to-ocean-600 rounded-xl flex items-center justify-center">
                            <i class="fas fa-water text-white text-lg"></i>
                        </div>
                        <span
                            class="text-xl font-bold bg-gradient-to-r from-ocean-600 to-ocean-800 bg-clip-text text-transparent">
                            Ocean Pearl Hotel
                        </span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if (function_exists('auth_check') && auth_check()): ?>
                            ...
                            <div class="relative group">
                                <button
                                    class="flex items-center space-x-2 text-gray-700 hover:text-ocean-600 gentle-hover px-3 py-2 rounded-lg">
                                ...
                                <div
                                    class="absolute right-0 mt-2 w-48 bg-white rounded-xl soft-shadow border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100">
                                    <div class="py-2">
                                        <a href="/profile"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-ocean-50 transition-colors">
                        ...
                        <?php else: ?>
                            <a href="/login" class="text-gray-700 hover:text-ocean-600 transition-colors font-medium">Đăng
                                nhập</a>
                ...
                <!-- Mobile menu button -->
                <div class="md:hidden">
                    <button type="button" class="text-gray-700 hover:text-ocean-600 gentle-hover p-2 rounded-lg"
            ...
            <div class="px-4 pt-2 pb-3 space-y-1">
                ...
                <?php if (function_exists('auth_check') && auth_check()): ?>
                    <div class="border-t border-gray-100 mt-2 pt-2">
                        <a href="/profile"
                            class="block px-3 py-3 text-gray-700 hover:bg-ocean-50 rounded-lg transition-colors">
                        ...
                        <form method="POST" action="/logout">
                            <button type="submit"
                                class="w-full text-left px-3 py-3 text-red-600 hover:bg-red-50 rounded-lg transition-colors">
                ...
                <?php else: ?>
                    <div class="border-t border-gray-100 mt-2 pt-2">
                        ...
                        <a href="/register"
                            class="block px-3 py-3 text-ocean-600 hover:bg-ocean-50 rounded-lg font-medium transition-colors">
    ...
    <!-- Footer -->
    <footer class="bg-gradient-to-r from-ocean-900 via-ocean-800 to-ocean-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    <div class="flex items-center mb-6">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-ocean-400 to-ocean-600 rounded-xl flex items-center justify-center mr-3">
                            <i class="fas fa-water text-white text-xl"></i>
                        </div>
                        <span class="font-bold text-2xl">Ocean Pearl Hotel</span>
                    </div>
                    <p class="text-gray-300 mb-4 leading-relaxed">
                        Khách sạn 5 sao với view biển tuyệt đẹp, dịch vụ chuyên nghiệp và không gian nghỉ dưỡng lý
                        tưởng.
                        Trải nghiệm những khoảnh khắc tuyệt vời bên gia đình và người thân.
                    </p>
                    <div class="flex space-x-4">
                        <a href="#"
                            class="w-10 h-10 bg-ocean-700 rounded-full flex items-center justify-center gentle-hover hover:bg-ocean-600">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-300">
                        <li><a href="/phong" class="hover:text-ocean-300 transition-colors gentle-hover">Phòng nghỉ</a>
                        </li>
                        <li><a href="/dich-vu" class="hover:text-ocean-300 transition-colors gentle-hover">Dịch vụ</a>
                        </li>
                        <li><a href="/tin-tuc" class="hover:text-ocean-300 transition-colors gentle-hover">Tin tức</a>
                        </li>
                        <li><a href="/about" class="hover:text-ocean-300 transition-colors gentle-hover">Về chúng
                                tôi</a></li>
                        <li><a href="/contact" class="hover:text-ocean-300 transition-colors gentle-hover">Liên hệ</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-3 text-gray-300">
                        <p class="flex items-start">
                            ...
                            <span>218 đường Lĩnh Nam<br>Hoàng Mai, Hà Nội, Việt Nam</span>
                        </p>
