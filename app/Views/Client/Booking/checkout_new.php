...
<style>
    ...
    .room-item:hover, .service-item:hover {
        border-color: #3b82f6;
        transform: translateY(-2px);
...
<div class="gradient-bg py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Breadcrumb -->
        <nav class="flex items-center space-x-2 text-white/80 mb-12">
            <a href="/" class="hover:text-white transition-colors text-sm">
                <i class="fas fa-home mr-1"></i>Trang chủ
            </a>
            <i class="fas fa-chevron-right text-xs"></i>
            <a href="/phong" class="hover:text-white transition-colors text-sm">Phòng</a>
            <i class="fas fa-chevron-right text-xs"></i>
            <span class="text-white font-medium text-sm">Đặt phòng</span>
        </nav>
                ...
                <form method="POST" action="/booking/process" id="bookingForm" class="space-y-8">
                    ...
                    <div class="section-card p-8">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button type="button" onclick="addRoom()" class="btn-secondary text-white px-6 py-3 rounded-xl font-semibold">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    <div>
                                        ...
                                        <select name="phongs[0][ma_phong]" required onchange="updateRoomPrice(this)"
                                            ...
                                            <?php if ($phong): ?>
                                                <option value="<?= $phong->ma_phong ?>" data-price="<?= $phong->gia ?>" selected>
                    ...
                    <div class="section-card p-8">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button type="button" onclick="addGeneralService()" class="btn-primary text-white px-6 py-3 rounded-xl font-semibold">
                                <i class="fas fa-plus mr-2"></i>Thêm dịch vụ
                            </button>
                        </div>
                    ...
                    <!-- Submit Button -->
                    <div class="text-center">
                        <button type="submit" class="btn-primary text-white px-12 py-4 rounded-xl text-lg font-semibold">
                ...
                <div class="total-card p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            <span class="text-white/80">Tiền phòng:</span>
                            <span class="font-bold text-xl" id="roomTotal">0₫</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-white/80">Tiền dịch vụ:</span>
                            <span class="font-bold text-xl" id="serviceTotal">0₫</span>
                        </div>
                        <hr class="border-white/20 my-4">
                        <div class="flex justify-between items-center">
                            <span class="text-2xl font-bold">Tổng cộng:</span>
                            <span class="text-3xl font-bold text-yellow-300" id="grandTotal">0₫</span>
                        </div>
                    </div>
