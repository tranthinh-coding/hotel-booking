    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="feature-card gentle-card rounded-3xl p-10 text-center group" data-delay="0.2">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Ẩm Thực Cao Cấp</h3>
                <p class="text-gray-600 leading-relaxed">
                    3 nhà hàng đẳng cấp với đầu bếp Michelin star, phục vụ các món ăn tinh tế 
                    từ hải sản tươi sống đến các đặc sản quốc tế.
                </p>
            </div>
            ...
            <div class="feature-card gentle-card rounded-3xl p-10 text-center group" data-delay="0.4">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Spa & Wellness</h3>
                <p class="text-gray-600 leading-relaxed">
                    Trung tâm spa 2000m² với liệu pháp trị liệu từ biển cả, 
                    mang đến sự thư giãn tuyệt đối cho cả thể chất và tinh thần.
                </p>
            </div>
            
            <div class="feature-card gentle-card rounded-3xl p-10 text-center group" data-delay="0.6">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Hồ Bơi Vô Cực</h3>
                <p class="text-gray-600 leading-relaxed">
                    Hồ bơi infinity edge với tầm nhìn panorama ra biển, 
                    tạo cảm giác như đang bơi giữa lòng đại dương bao la.
                </p>
            </div>
            
            <div class="feature-card gentle-card rounded-3xl p-10 text-center group" data-delay="0.8">
                <div class="w-20 h-20 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-dumbbell text-3xl text-white"></i>
                </div>
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Gym & Thể Thao</h3>
                <p class="text-gray-600 leading-relaxed">
                    Phòng gym hiện đại với trang thiết bị Technogym và sân tennis, 
                    giúp bạn duy trì sức khỏe trong kỳ nghỉ.
                </p>
            </div>
            
            <div class="feature-card gentle-card rounded-3xl p-10 text-center group" data-delay="1.0">
                <div class="w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-concierge-bell text-3xl text-white"></i>
                </div>
                <h3 class="text-2xl font-bold text-gray-800 mb-4">Dịch Vụ 24/7</h3>
                <p class="text-gray-600 leading-relaxed">
                    Đội ngũ concierge chuyên nghiệp luôn sẵn sàng phục vụ mọi nhu cầu của bạn, 
                    từ đặt tour du lịch đến các dịch vụ cá nhân hóa.
                </p>
            </div>
        </div>
    </div>
