...
<div class="contact-page-wrapper relative min-h-screen">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 py-16">
        ...
        <div class="text-center mb-16 contact-header">
            <div
                class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full mb-6 shadow-xl">
                <i class="fas fa-comments text-white text-2xl"></i>
            </div>
            <h1
                class="text-5xl font-bold bg-gradient-to-r from-indigo-700 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-6 contact-title">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-150 hover:-translate-y-1">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="xl:col-span-2">
                    <div
                        class="contact-form-card bg-white/90 backdrop-blur-xl rounded-3xl shadow-md p-8 border border-white/30">
                        <div class="flex items-center mb-8">
                            ...
                            <h2
                                class="text-2xl font-bold bg-gradient-to-r from-indigo-700 to-purple-600 bg-clip-text text-transparent">
                        ...
                        <form action="/contact" method="POST" class="space-y-6 contact-form">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <select id="chu_de" name="chu_de"
                                        ...
                                        <option value="dat_phong" <?= old('chu_de') === 'dat_phong' ? 'selected' : '' ?>>🏨
                                            Đặt phòng</option>
                                        <option value="dich_vu" <?= old('chu_de') === 'dich_vu' ? 'selected' : '' ?>>🛎️
                                            Dịch vụ</option>
                                        <option value="khieu_nai" <?= old('chu_de') === 'khieu_nai' ? 'selected' : '' ?>>⚠️
                                            Khiếu nại</option>
                                        <option value="gop_y" <?= old('chu_de') === 'gop_y' ? 'selected' : '' ?>>💡 Góp ý
                                        </option>
                                        <option value="su_kien" <?= old('chu_de') === 'su_kien' ? 'selected' : '' ?>>🎉 Tổ
                                            chức sự kiện</option>
                                        <option value="khac" <?= old('chu_de') === 'khac' ? 'selected' : '' ?>>📝 Khác
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start p-4 bg-indigo-50/50 rounded-2xl border border-indigo-100">
                                <input type="checkbox" id="dong_y_xu_ly" name="dong_y_xu_ly" value="1"
                                ...
                                <label for="dong_y_xu_ly" class="ml-3 text-sm text-gray-700 leading-relaxed">
                                    Tôi đồng ý để Hotel Ocean xử lý thông tin cá nhân của tôi để phản hồi yêu cầu này
                                    theo
                                    <a href="/privacy-policy"
                                        class="text-indigo-600 hover:text-indigo-700 underline font-semibold">Chính sách
                                        bảo mật</a> *
                                </label>
                            </div>
                            ...
                            <button type="submit"
                                ...
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-150">
                                </div>
                            </button>
                        </form>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div
                        class="contact-info-card bg-white/90 backdrop-blur-xl rounded-3xl shadow-md p-8 border border-white/30 hover:shadow-lg transition-all duration-150">
                        <div class="flex items-center mb-6">
                            ...
                            <h2
                                class="text-xl font-bold bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text text-transparent">
                                Thông tin liên hệ
                            </h2>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div
                                class="contact-item flex items-start group hover:transform hover:scale-105 transition-all duration-150">
                                <div
                                    class="w-14 h-14 bg-gradient-to-r from-indigo-100 to-indigo-200 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:shadow-sm transition-all">
                            ...
                            <div
                                class="contact-item flex items-start group hover:transform hover:scale-105 transition-all duration-150">
                                <div
                                    class="w-14 h-14 bg-gradient-to-r from-green-100 to-green-200 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:shadow-sm transition-all">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600 leading-relaxed">
                                        <a href="tel:+84123456789"
                                            class="hover:text-indigo-600 transition-colors font-semibold">Hotline: (+84)
                                            123 456 789</a><br>
                                        <a href="tel:+84987654321"
                                            class="hover:text-purple-600 transition-colors font-semibold">Đặt phòng:
                                            (+84) 987 654 321</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                class="contact-item flex items-start group hover:transform hover:scale-105 transition-all duration-150">
                                <div
                                    class="w-14 h-14 bg-gradient-to-r from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:shadow-sm transition-all">
                                    <i class="fas fa-envelope text-blue-600 text-xl"></i>
                                </div>
                                <div class="ml-4">
                                    <h3 class="font-bold text-gray-800 mb-2 text-lg">Email</h3>
                                    <p class="text-gray-600 leading-relaxed">
                                        <a href="mailto:info@hotelocean.com"
                                            class="hover:text-indigo-600 transition-colors font-semibold">info@hotelocean.com</a><br>
                                        <a href="mailto:booking@hotelocean.com"
                                            class="hover:text-purple-600 transition-colors font-semibold">booking@hotelocean.com</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                class="contact-item flex items-start group hover:transform hover:scale-105 transition-all duration-150">
                                <div
                                    class="w-14 h-14 bg-gradient-to-r from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:shadow-sm transition-all">
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-pink-500 to-rose-600 rounded-xl flex items-center justify-center mr-4">
                                <i class="fas fa-share-alt text-white text-lg"></i>
                            </div>
                            <h3
                                class="text-xl font-bold bg-gradient-to-r from-pink-700 to-rose-600 bg-clip-text text-transparent">
                                Kết nối với chúng tôi
                            </h3>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <a href="#"
                                class="social-link flex items-center p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl hover:from-blue-100 hover:to-blue-200 transition-all duration-150 transform hover:scale-105 hover:shadow-sm">
                                <i class="fab fa-facebook-f text-blue-600 text-xl mr-3"></i>
                                <span class="text-gray-700 font-semibold">Facebook</span>
                            </a>
                            <a href="#"
                                class="social-link flex items-center p-4 bg-gradient-to-r from-pink-50 to-pink-100 rounded-2xl hover:from-pink-100 hover:to-pink-200 transition-all duration-150 transform hover:scale-105 hover:shadow-sm">
                                <i class="fab fa-instagram text-pink-600 text-xl mr-3"></i>
                                <span class="text-gray-700 font-semibold">Instagram</span>
                            </a>
                            <a href="#"
                                class="social-link flex items-center p-4 bg-gradient-to-r from-red-50 to-red-100 rounded-2xl hover:from-red-100 hover:to-red-200 transition-all duration-150 transform hover:scale-105 hover:shadow-sm">
                                <i class="fab fa-youtube text-red-600 text-xl mr-3"></i>
                                <span class="text-gray-700 font-semibold">YouTube</span>
                            </a>
                            <a href="#"
                                class="social-link flex items-center p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-2xl hover:from-green-100 hover:to-green-200 transition-all duration-150 transform hover:scale-105 hover:shadow-sm">
            ...
            <div class="mt-16">
                <div
                    class="map-section bg-white/90 backdrop-blur-xl rounded-3xl shadow-md overflow-hidden border border-white/30">
                    <div class="p-8 border-b border-gray-100">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center mr-4">
                                <i class="fas fa-map text-white text-lg"></i>
                            </div>
                            <h2
                                class="text-2xl font-bold bg-gradient-to-r from-cyan-700 to-blue-600 bg-clip-text text-transparent">
                                Vị trí khách sạn
                            </h2>
                        </div>
                        <p class="text-gray-600 leading-relaxed">
                    ...
                    <div
                        class="h-96 bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center relative overflow-hidden">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2757.3035413869093!2d109.20266030684559!3d12.220083192456686!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31706700768e164d%3A0x87faf37222cf7d07!2zMDMgSG_DoG5nIERp4buHdQ!5e0!3m2!1svi!2s!4v1752672587228!5m2!1svi!2s"
            ...
            <div class="mt-16">
                <div class="text-center mb-12">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full mb-6 shadow-md">
                        <i class="fas fa-question-circle text-white text-xl"></i>
                    </div>
                    <h2
                        class="text-4xl font-bold bg-gradient-to-r from-amber-700 via-orange-600 to-red-600 bg-clip-text text-transparent mb-4">
                        Câu hỏi thường gặp
                    </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div
                        class="faq-card bg-white/90 backdrop-blur-xl rounded-3xl shadow-sm p-8 border border-white/30 hover:shadow-md transition-all duration-150 transform hover:-translate-y-1">
                        <div class="flex items-start mb-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-red-500 to-pink-600 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-amber-500 to-yellow-600 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
            ...
            <div class="mt-20">
                <div class="text-center mb-12">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-rose-500 to-pink-600 rounded-full mb-6 shadow-md">
                        <i class="fas fa-heart text-white text-xl"></i>
                    </div>
                    <h2
                        class="text-4xl font-bold bg-gradient-to-r from-rose-700 via-pink-600 to-purple-600 bg-clip-text text-transparent mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        class="testimonial-card bg-white/90 backdrop-blur-xl rounded-3xl shadow-sm p-6 border border-white/30 hover:shadow-md transition-all duration-150 transform hover:-translate-y-1">
                        <div class="flex items-center mb-4">
                        ...
                        <blockquote class="text-gray-700 mb-6 leading-relaxed italic">
                            "Dịch vụ tuyệt vời! Nhân viên rất thân thiện và chuyên nghiệp. Phòng sạch sẽ, view biển đẹp.
                    ...
                    <div
                        ...
                        <blockquote class="text-gray-700 mb-6 leading-relaxed italic">
                            "Honeymoon tuyệt vời tại đây! Spa thư giãn, món ăn ngon. Nhân viên hỗ trợ nhiệt tình từ lúc
                            check-in đến check-out."
                        </blockquote>
                        <div class="flex items-center">
                            <div
                                class="w-10 h-10 bg-gradient-to-r from-pink-500 to-red-600 rounded-full flex items-center justify-center mr-3">
                    ...
                    <div
                        ...
                        <blockquote class="text-gray-700 mb-6 leading-relaxed italic">
                            "Vị trí hoàn hảo! Gần biển, gần trung tâm. Bể bơi đẹp, phòng gym đầy đủ thiết bị. Rất đáng
                            tiền!"
                        </blockquote>
                        <div class="flex items-center">
                            <div
            ...
            <div class="mt-20">
                <div
                    class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-12 text-white relative overflow-hidden">
                    <!-- Background decoration -->
                    <div class="absolute inset-0 opacity-10">
                        <div
                            class="absolute top-0 right-0 w-64 h-64 bg-white rounded-full transform translate-x-32 -translate-y-32">
                        </div>
                        <div
                            class="absolute bottom-0 left-0 w-48 h-48 bg-white rounded-full transform -translate-x-24 translate-y-24">
                        </div>
                    </div>
            ...
            <div class="mt-20 text-center">
                <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-md p-12 border border-white/30">
                    ...
                    <h2
                        class="text-4xl font-bold bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text text-transparent mb-6">
