...
<div class="min-h-screen ocean-gradient-bg">
    ...
    <div class="relative overflow-hidden">
        <div class="absolute inset-0 parallax-element">
            ...
            <div class="absolute top-40 right-20 w-12 h-12 bg-cyan-200/30 rounded-full animate-pulse" style="animation-delay: 1s;"></div>
            <div class="absolute bottom-20 left-20 w-20 h-20 bg-teal-200/30 rounded-full animate-pulse" style="animation-delay: 2s;"></div>
        </div>
        
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center hero-content">
                <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-full text-blue-600 text-sm font-medium mb-8 gentle-card">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 items-center">
            ...
            <div class="story-image">
                <div class="relative">
                    ...
                    <!-- Floating stats -->
                    <div class="absolute -bottom-6 -left-6 gentle-card rounded-2xl p-6 bg-gradient-to-r from-blue-500 to-cyan-500 text-white">
                        <div class="text-3xl font-bold">98%</div>
                        <div class="text-sm">Khách hàng hài lòng</div>
                    </div>
                    <div class="absolute -top-6 -right-6 gentle-card rounded-2xl p-6 bg-gradient-to-r from-teal-500 to-green-500 text-white">
        ...
        <div class="mb-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center ocean-feature" data-delay="0">
                    <div class="gentle-card rounded-3xl p-8 mb-6 hover:scale-105 transition-transform duration-300">
                ...
                <div class="text-center ocean-feature" data-delay="0.2">
                    <div class="gentle-card rounded-3xl p-8 mb-6 hover:scale-105 transition-transform duration-300">
                        <div class="w-16 h-16 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
        ...
        <div class="gentle-card rounded-3xl p-12 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="commitment-item" data-delay="0.4">
                    <div class="w-20 h-20 bg-gradient-to-r from-teal-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
        ...
        <!-- Environmental Commitment -->
        <div class="gentle-card rounded-3xl p-12 text-center mb-24">
            <h2 class="text-4xl font-bold text-gray-800 mb-6">
                <span class="ocean-wave-text">Cam kết</span> bảo vệ môi trường biển
            </h2>
            <p class="text-xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
        ...
        <div class="text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="/phong" 
                   class="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-3 rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg inline-flex items-center">
