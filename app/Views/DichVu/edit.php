<?php
$title = 'Chỉnh sửa dịch vụ - Hotel Ocean';
ob_start();
?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <div class="flex items-center space-x-4 mb-6">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Chỉnh sửa dịch vụ</h1>
                <p class="text-gray-600">Cập nhật thông tin: <?= htmlspecialchars($dichVu->ten_dich_vu ?? '') ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <form action="/dich-vu/<?= $dichVu->id ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" 
                               id="ten_dich_vu" 
                               name="ten_dich_vu" 
                               value="<?= htmlspecialchars(old('ten_dich_vu') ?: ($dichVu->ten_dich_vu ?? '')) ?>"
                    ...
                    <div>
                        ...
                        <select id="loai_dich_vu" 
                            ...
                            <option value="spa" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'spa' ? 'selected' : '' ?>>Spa & Wellness</option>
                            <option value="restaurant" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'restaurant' ? 'selected' : '' ?>>Nhà hàng</option>
                            <option value="entertainment" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'entertainment' ? 'selected' : '' ?>>Giải trí</option>
                            <option value="transport" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'transport' ? 'selected' : '' ?>>Vận chuyển</option>
                            <option value="laundry" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'laundry' ? 'selected' : '' ?>>Giặt ủi</option>
                            <option value="business" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'business' ? 'selected' : '' ?>>Dịch vụ doanh nghiệp</option>
                            <option value="other" <?= (old('loai_dich_vu') ?: ($dichVu->loai_dich_vu ?? '')) === 'other' ? 'selected' : '' ?>>Khác</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="gia_dich_vu" 
                               name="gia_dich_vu" 
                               value="<?= htmlspecialchars(old('gia_dich_vu') ?: ($dichVu->gia_dich_vu ?? '')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                               required
                               min="0"
                               step="1000"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="thoi_gian" 
                               name="thoi_gian" 
                               value="<?= htmlspecialchars(old('thoi_gian') ?: ($dichVu->thoi_gian ?? '')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                               min="5"
                               max="480"
                               placeholder="VD: 60">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" 
                               id="dia_diem" 
                               name="dia_diem" 
                               value="<?= htmlspecialchars(old('dia_diem') ?: ($dichVu->dia_diem ?? '')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="suc_chua" 
                               name="suc_chua" 
                               value="<?= htmlspecialchars(old('suc_chua') ?: ($dichVu->suc_chua ?? '')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                               min="1"
                               max="100"
                               placeholder="VD: 10">
                    ...
                    <div>
                        ...
                        <select id="trang_thai" 
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                                required>
                            <option value="active" <?= (old('trang_thai') ?: ($dichVu->trang_thai ?? '')) === 'active' ? 'selected' : '' ?>>Hoạt động</option>
                            <option value="inactive" <?= (old('trang_thai') ?: ($dichVu->trang_thai ?? '')) === 'inactive' ? 'selected' : '' ?>>Tạm dừng</option>
                            <option value="maintenance" <?= (old('trang_thai') ?: ($dichVu->trang_thai ?? '')) === 'maintenance' ? 'selected' : '' ?>>Bảo trì</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="time" 
                               id="gio_mo" 
                               name="gio_mo" 
                               value="<?= htmlspecialchars(old('gio_mo') ?: ($dichVu->gio_mo ?? '08:00')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="time" 
                               id="gio_dong" 
                               name="gio_dong" 
                               value="<?= htmlspecialchars(old('gio_dong') ?: ($dichVu->gio_dong ?? '22:00')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all">
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea id="mo_ta" 
                                  ...
                                  rows="5"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                                  placeholder="Mô tả chi tiết về dịch vụ, quy trình, lợi ích..."><?= htmlspecialchars(old('mo_ta') ?: ($dichVu->mo_ta ?? '')) ?></textarea>
                    </div>
                    ...
                    <?php if (!empty($dichVu->hinh_anh)): ?>
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <img src="<?= htmlspecialchars($dichVu->hinh_anh) ?>" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="yeu_cau_dat_truoc" 
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all">
                            <option value="0" <?= (old('yeu_cau_dat_truoc') ?: ($dichVu->yeu_cau_dat_truoc ?? '0')) === '0' ? 'selected' : '' ?>>Không bắt buộc</option>
                            <option value="1" <?= (old('yeu_cau_dat_truoc') ?: ($dichVu->yeu_cau_dat_truoc ?? '0')) === '1' ? 'selected' : '' ?>>Đặt trước 1 giờ</option>
                            <option value="2" <?= (old('yeu_cau_dat_truoc') ?: ($dichVu->yeu_cau_dat_truoc ?? '0')) === '2' ? 'selected' : '' ?>>Đặt trước 2 giờ</option>
                            <option value="4" <?= (old('yeu_cau_dat_truoc') ?: ($dichVu->yeu_cau_dat_truoc ?? '0')) === '4' ? 'selected' : '' ?>>Đặt trước 4 giờ</option>
                            <option value="24" <?= (old('yeu_cau_dat_truoc') ?: ($dichVu->yeu_cau_dat_truoc ?? '0')) === '24' ? 'selected' : '' ?>>Đặt trước 1 ngày</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="huy_truoc" 
                               name="huy_truoc" 
                               value="<?= htmlspecialchars(old('huy_truoc') ?: ($dichVu->huy_truoc ?? '2')) ?>"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                               min="0"
                               max="72"
                               placeholder="VD: 2">
...
document.getElementById('hinh_anh').addEventListener('change', function() {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            const currentImg = document.querySelector('img[alt="<?= htmlspecialchars($dichVu->ten_dich_vu ?? '') ?>"]');
            if (currentImg) {
