                    ...
                    <form action="/admin/phong/store" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="ten_phong" name="ten_phong" required
                                ...
                                placeholder="VD: P101, Deluxe Room 201..." oninput="updatePreview()">
                            ...
                            <select id="ma_loai_phong" name="ma_loai_phong" required
                                ...
                                <?php foreach ($loaiPhongs as $loaiPhong): ?>
                                    <option value="<?= $loaiPhong->ma_loai_phong ?>"
                                        <?= get('ma_loai_phong') == $loaiPhong->ma_loai_phong ? 'selected' : '' ?>>
                                        <?= htmlspecialchars($loaiPhong->ten) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <p class="mt-1 text-sm text-grẢnh bìa phòng (cover iay-500">Chọn loại phòng phù hợp</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="gia" name="gia" min="0" required
                                    ...
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="500000" oninput="updatePreview()">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Chọn ảnh bìa nổi bật cho phòng này. PNG, JPG,
                                    GIF tối đa 10MB.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="mo_ta" name="mo_ta" rows="4"
                                ...
                                oninput="updatePreview()"><?= htmlspecialchars(get('mo_ta', '')) ?></textarea>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="hinh_anh"
                                            ...
                                            <input id="hinh_anh" name="hinh_anh[]" type="file" accept="image/*" multiple
                                                class="sr-only" onchange="previewImages(this)">
                                        </label>
                                        <p class="pl-1">hoặc kéo thả</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PNG, JPG, GIF tối đa 10MB mỗi file. Có thể chọn
                                        nhiều ảnh.</p>
                                </div>
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span id="preview-tranghai"
                                    class="text-sm px-2 py-1 rounded-full bg-green-100 text-green-800">Đang hoạt
                                    động</span>
                            </div>
                            <div class="flex justify-between">
...
<script>
    ...
    function updatePreview() {
        ...
        if (anhBiaInput.files && anhBiaInput.files[0]) {
            ...
            reader.readAsDataURL(anhBiaInput.files[0]);
        } else {
